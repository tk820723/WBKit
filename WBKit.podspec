#
#  Be sure to run `pod spec lint WBKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "tk820723" => "tk820723@hotmail.com" }
  # Or just: s.author    = "tk820723"
  # s.authors            = { "tk820723" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/tk820723"
  ...
  s.source       = { :git => "https://github.com/tk820723/WBKit.git", :tag => "#{s.version}" }
